SinuousWorld = new function(){
  ...
  function gameOver() {
    ...
    title.innerHTML = '¡Fin del Juego! (' + Math.round( score ) + ' puntos)';
  }
  ...
  function loop() {
    ...
    if( playing ) {
      scoreText = 'Puntaje: <span>' + Math.round( score ) + '</span>';
      scoreText += ' Tiempo: <span>' + Math.round( ( ( new Date().getTime() - time ) / 1000 ) * 100 ) / 100 + 's</span>';
